...
class TestPosConventionalBarcodeScannerJs(HttpCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_pos_conventional_barcode_scanner_hoot_suite(self):
        suite_name = "@pos_conventional_barcode_scanner/pos_conventional_barcode_scanner"
